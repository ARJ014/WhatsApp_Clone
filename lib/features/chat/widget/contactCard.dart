                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: ((context, index) {
                        GroupModel contact = snapshot.data![index];
                        return Padding(
                          ...
                          child: Column(
                            children: [
                              InkWell(
                                onTap: () {
                                  Navigator.pushNamed(
                                      context, ChatScreenMobile.name,
                                      arguments: {
                                        'name': contact.name,
                                        'uid': contact.groupId,
                                        'isGroupChat': true,
                                        'profilePic': contact.groupPic
                                      });
                                },
                                child: ListTile(
                                  leading: Container(
                                  ...
                                  trailing: Text(
                                      DateFormat.Hm().format(contact.time),
